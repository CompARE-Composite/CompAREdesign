...
samplesize_cbe <- function(p0_e1, p0_e2, eff_e1, effm_e1, eff_e2, effm_e2, effm_ce="diff", rho, alpha = 0.05, beta = 0.2, unpooled = TRUE){
  ...
  if(effm_ce == "rr"){
    rr_CBE <- effectsize_cbe(p0_e1, p0_e2, p1_e1, p1_e2, rho, effm_ce = "rr")[1,3]
    if(unpooled == TRUE){
    ...
    or_CBE = effectsize_cbe(p0_e1, p0_e2, p1_e1, p1_e2, rho, effm_ce = "or")[1,3]
    ...
    diff_CBE <- effectsize_cbe(p0_e1, p0_e2, p1_e1, p1_e2, rho, effm_ce = "rr")[1,3]
    if(unpooled== TRUE){
